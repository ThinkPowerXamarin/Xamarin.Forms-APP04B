using App1.CustomVisualElement;
using System;
...
namespace App1
{
    public class App : Application
    {
        ...
        public App()
        {
            ...
            NavigationPage = new NavigationPage(new Page1() { BindingContext = vm });
    ...
    public class Page1ViewModel : ViewModelBase
    {
        ...
        private Command _CmdAdd = new Command<ItemViewModel>((instance) =>
        {
            ...
            var amap1 = new MyAMapPage();
            App.NavigationPage.PushAsync((Page)amap1);
        });
    }
